...
var BaseAuthStrategy = (function () {
     ...
     * @param {?} document
     */
    function BaseAuthStrategy(http, router, _config, document) {
        var _this = this;
        this.http = http;
        this.router = router;
    ...
    ;
    Object.defineProperty(BaseAuthStrategy.prototype, "log", {
        /**
         * @return {?}
         */
        get: function () { return this.config.log; },
        enumerable: true,
        configurable: true
    });
    ;
