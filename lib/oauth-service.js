...
var OAuthService = (function () {
     ...
     */
    function OAuthService(http, _config, _strategyFactory) {
        var _this = this;
        this.http = http;
    ...
    ;
    Object.defineProperty(OAuthService.prototype, "log", {
        /**
         * @return {?}
         */
        get: function () { return this._config.log; },
        enumerable: true,
        configurable: true
    });
     ...
     * @return {?}
     */
    OAuthService.prototype.refreshSession = function () { return this.strategy.refreshSession(); };
...
//# sourceMappingURL=D:/temp/angular-oauth2-oidc/src/oauth-service.js.map